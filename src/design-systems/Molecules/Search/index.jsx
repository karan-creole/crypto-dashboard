...
const Search = ({ walletAddress, setWalletAddress, getDetailsByAddress }) => {
    ...
    <div className="flex flex-col">
      <div className="flex flex-row items-center">
        <input
          ...
          onKeyDown={(e) => e.key == 'Enter' && getDetailsByAddress()}
        ...
        />
        <button
          className="flex ml-4 bg-indigo-500 p-2 rounded-lg"
          onClick={() => getDetailsByAddress()}
        >
          <svg
